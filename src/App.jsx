...
//             <div className="navbar absolute top-0 left-0 z-[10] w-full py-6 px-8">
...
//                 </div>
//                 <h3 className="text-3xl -mt-[6px] leading-none text-white">Rockstar</h3>
//               </div>
//             </div>

//             <div className="imagesdiv relative overflow-hidden w-full h-screen">
//               <img
//                 className="absolute sky scale-[1.3] rotate-[-20deg] top-0 left-0 w-full h-full object-cover"
//                 src="./sky.png"
//                 alt=""
//               />
//               <img
...
//                 alt=""
//               />
//               <div className="text text-white flex flex-col gap-2 absolute top-28 left-1/2 -translate-x-1/2 scale-[0.8] rotate-[-10deg]">
...
//               </div>
//               <img
//                 className="absolute character left-1/2 -translate-x-1/2 bottom-0 scale-[1.2] rotate-[-5deg]"
//                 src="./girlbg.png"
//                 alt=""
//               />
//             </div>
...
//                   <img src="./ps5.png" className="h-[25px]" alt="ps5" />
//                   <img src="./xbox.png" className="h-[25px]" alt="xbox" />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//             <div className="cntnr flex text-white w-[90%] h-full items-center">
//               <div className="limg relative w-1/2 h-[90%]">
//                 <img
...
//                 <p className="mt-6 text-md font-[Helvetica_Now_Display]">
//                   Lorem ipsum dolor sit amet consectetur adipisicing elit.
//                   Distinctio possimus, asperiores nam, omnis inventore nesciunt
//                   a architecto eveniet saepe, ducimus necessitatibus at voluptate.
//                 </p>
//                 <p className="mt-2 text-md font-[Helvetica_Now_Display]">
...
//                   autem sapiente.
//                 </p>
//                 <button className="bg-yellow-500 px-8 py-4 text-black mt-6 text-2xl">
//                   Download Now
//                 </button>
//               </div>
//             </div>
